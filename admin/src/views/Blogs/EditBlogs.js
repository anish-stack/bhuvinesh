...
function EditBlogs() {
    ...
    const handleFetchBlog = async () => {
        try {
            const { data } = await axios.get(`https://www.apidemo.propsavvyrealtors.com/api/v1/get_blog/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.put(`https://www.apidemo.propsavvyrealtors.com/api/v1/update_blog/${id}`, payload, {
